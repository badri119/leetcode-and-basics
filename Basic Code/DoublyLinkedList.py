#Doubly Linked List which includes constructing, appending, popping, prepending, pop first, get, set, insert and remove
...
#Drawing a Diagram will make a lot of sense and will make it easier to understand.